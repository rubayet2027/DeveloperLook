...
const blogPosts = [
  {
    id: 1,
    category: 'News',
    title: "Ryan McNamara Promoted to Global Operations Director",
    image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&h=800&q=90&auto=format&fit=crop',
    href: '/blog/global-operations-director',
  },
  {
    id: 2,
    category: 'Case Study',
    title: "How We Drove 340% Organic Growth for SIXT",
    image: 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?w=800&h=800&q=90&auto=format&fit=crop',
    href: '/blog/sixt-case-study',
  },
  {
    id: 3,
    category: 'Insights',
    title: 'The Future of Search: AI, LLMs and What It Means for Brands',
    image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&h=800&q=90&auto=format&fit=crop',
    href: '/blog/future-of-search',
  },
  {
    id: 4,
    category: 'Digital PR',
    title: 'Creative Campaigns That Earned 10,000+ Links',
    image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=800&q=80&auto=format&fit=crop',
    href: '/blog/digital-pr-campaigns',
  },
]
...
export default function WhatsNew() {
  ...
  return (
    <section ref={ref} className="bg-site-bg py-16 lg:py-24 overflow-hidden">
      ...
      <div className="flex gap-4 px-5 lg:px-10 overflow-x-auto no-scrollbar pb-4">
