...
const footerLinks = [
  ...
  {
    items: ['Testimonials', 'Blog & Resources', 'Webinars', 'Careers'],
  },
  {
        ...
        <div className="bg-dark rounded-t-[24px] lg:rounded-t-[32px] overflow-hidden">
          ...
          <div className="px-8 lg:px-14 xl:px-20 pb-6 lg:pb-8" ref={wordmarkRef}>
            <div className="flex items-end justify-between">
              ...
              {/* ® symbol */}
              <span className="text-white text-lg lg:text-2xl font-bold ml-2 mb-1">®</span>
            </div>
          </div>

          {/* Bottom bar */}
          <div className="px-8 lg:px-14 xl:px-20 py-4 border-t border-white/10">
            <div className="flex flex-col sm:flex-row justify-between gap-3 text-white/30 text-[11px]">
